...
public class Addpassengercontroller implements Initializable {
    ...
    public void ajout_passenger(MouseEvent event) throws SQLException {
       ...
       if( ! AvaiblePassenger(Integer.parseInt(idpassenger),a)){
        ...
        String sql ="INSERT INTO `reservation` (`ID_reservation`,`ID_admin`, `ID_passenger`, `ID_vol`,`price`) VALUES(NULL,?,?,?,?)";
        statement = connection.prepareStatement(sql);
        statement.setInt(1, AdminDAO.user_id);
        statement.setInt(2, Integer.parseInt(idpassenger));
        statement.setInt(3, Integer.parseInt(nvol));
